...
namespace QTHungryDogsCustomer.WebApi.Controllers.Account
{
    ...
    using TEditModel = QTHungryDogsCustomer.WebApi.Models.Account.AccessRoleEdit;
    using TOutModel = QTHungryDogsCustomer.WebApi.Models.Account.AccessRole;
    ///
    ...
    public sealed partial class AccessRolesController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public AccessRolesController(QTHungryDogsCustomer.Logic.Contracts.Account.IRolesAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
