...
{
    using TAccessModel = QTHungryDogsCustomer.Logic.Models.Account.User;
    using TEditModel = QTHungryDogsCustomer.WebApi.Models.Account.IdentityUserEdit;
    using TOutModel = QTHungryDogsCustomer.WebApi.Models.Account.IdentityUser;
    ///
    ...
    public sealed partial class IdentityUsersController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public IdentityUsersController(QTHungryDogsCustomer.Logic.Contracts.Account.IUsersAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
