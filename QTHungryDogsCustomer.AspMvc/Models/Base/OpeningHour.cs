...
namespace QTHungryDogsCustomer.AspMvc.Models.Base
{
    ...
    public partial class OpeningHour
    {
        ...
        /// Generated by the generator
        ///
        public static QTHungryDogsCustomer.AspMvc.Models.Base.OpeningHour Create(QTHungryDogsCustomer.Logic.ServiceModels.Base.OpeningHour other)
        {
            BeforeCreate(other);
            var result = new QTHungryDogsCustomer.AspMvc.Models.Base.OpeningHour();
        ...
        static partial void BeforeCreate(QTHungryDogsCustomer.Logic.ServiceModels.Base.OpeningHour other);
        static partial void AfterCreate(QTHungryDogsCustomer.AspMvc.Models.Base.OpeningHour instance, QTHungryDogsCustomer.Logic.ServiceModels.Base.OpeningHour other);
        ///
        /// Generated by the generator
        ///
        public void CopyProperties(QTHungryDogsCustomer.Logic.ServiceModels.Base.OpeningHour other)
        {
            bool handled = false;
        ...
        partial void BeforeCopyProperties(QTHungryDogsCustomer.Logic.ServiceModels.Base.OpeningHour other, ref bool handled);
        partial void AfterCopyProperties(QTHungryDogsCustomer.Logic.ServiceModels.Base.OpeningHour other);
        ///
        /// Generated by the generator
        ///
