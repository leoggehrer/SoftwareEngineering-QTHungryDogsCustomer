...
namespace QTHungryDogsCustomer.AspMvc.Controllers.Base
{
    ...
    using FilterType = QTHungryDogsCustomer.AspMvc.Models.Base.RestaurantInfoFilter;
    ///
    ...
    public sealed partial class RestaurantsController : Controllers.GenericController<AccessType, ModelType>
    {
        ...
        public override async Task<IActionResult> Index()
        {
            ...
            var instanceAccess = DataAccess as Logic.Contracts.Base.IRestaurantsService<Logic.ServiceModels.Base.Restaurant>;

            var predicate = filter.CreateEntityPredicate();
            var accessModels = await instanceAccess!.QueryRestaurantInfosAsync(predicate, orderBy);
            var viewModels = AfterQuery(accessModels).Select(e => ToViewModel(e, ActionMode.Index));

            ViewBag.Filter = filter;
            ViewBag.OrderBy = orderBy;
            ViewBag.PageSize = pageSize;
            ViewBag.ModelCount = viewModels.Count();
