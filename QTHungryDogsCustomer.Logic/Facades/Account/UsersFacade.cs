...
//MdStart
#if ACCOUNT_ON
namespace QTHungryDogsCustomer.Logic.Facades.Account
{
    ...
    public sealed partial class UsersFacade : FacadeObject, Contracts.Account.IUsersAccess<TModel>
    {
        ...
        public UsersFacade()
        : base(new QTHungryDogsCustomer.Logic.Controllers.Account.UsersController())
        {
            Constructing();
            Constructed();
        }
        public UsersFacade(FacadeObject facadeObject)
        : base(new QTHungryDogsCustomer.Logic.Controllers.Account.UsersController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
