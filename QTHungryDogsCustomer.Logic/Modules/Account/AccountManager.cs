...
using QTHungryDogsCustomer.Logic.Controllers;
using QTHungryDogsCustomer.Logic.Entities.Account;
using QTHungryDogsCustomer.Logic.Modules.Exceptions;
using QTHungryDogsCustomer.Logic.Modules.Security;
...
namespace QTHungryDogsCustomer.Logic.Modules.Account
{
                ...
                if (session != null && session.IsActive)
                {
                    ...
                    if (identity != null)
                    {
                        ...
                        session.JsonWebToken = JsonWebToken.GenerateToken(new Claim[]
                        {
                            ...
                            new Claim(ClaimTypes.System, nameof(QTHungryDogsCustomer)),
